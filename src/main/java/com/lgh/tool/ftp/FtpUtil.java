...
public class FtpUtil {
    ...
    public FtpUtil() {
        ...
        basePath=prop.getProperty("file.basePath");
    }
    /**
     *
    ...
    public static void main(String []args) {
        ...
        FileInputStream in;
        try {
            File file=new File("E:\\194343.jpg");
            in=new FileInputStream(file);
            FtpUtil ftputil=new FtpUtil();
            boolean flag=ftputil.fileUpload("/2019/07/26", file.getName(), in);
        ...
        //删除测试--------------------------------------
       /* FtpUtil ftputil=new FtpUtil();
        boolean flag=ftputil.deleteFile("/2019/07/26/194343.jpg");
